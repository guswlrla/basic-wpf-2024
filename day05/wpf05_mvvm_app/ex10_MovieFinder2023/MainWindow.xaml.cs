...
namespace ex10_MovieFinder2024
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        {
            string tmdb_apiKey = "23fa6d1e67f73998ed1afd208b3385c0"; // TMDB사이트에서 제공받은 API키
            ...
            var jsonArray = results as JArray; // results가 json 배열이기 때문에 JArray는 List와 동일-> foreach 사용가능
            ...
            foreach (var item in jsonArray)
            {
                ...
                {
                    // 프로퍼티라 대문자로 시작, json 자체 키가 adult
        ...
        private async void BtnAddFavorite_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (isFavorite == true) // 즐겨찾기 보기에서 영화를 다시 즐겨찾기 하려고 할 때 막음
            {
