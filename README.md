...
- WPF MVVM
    ...
    - MVVM(Model View ViewModel)
        ...
        ![MVVM패턴](https://raw.githubusercontent.com/guswlrla/basic-wpf-2024/main/images/wpf0001.png)
    ...
    - MVVM 구현 도와주는 프레임워크
        ...
        1. **Caliburn.Micro** - 3rd Party 개발, MVVM이 매우 간단하고 강력함, 중소형 프로젝트에 적합, 디버깅이 어려움
        2. Avalonia - 3rd Party 개발, 크로스플랫폼, 디자인 굿
...
- Caliburn.Micro
    ...
    - 작업(3명) 분리
        ...
        - Xaml 디자이너 - Views 폴더에 있는 xaml 파일 디자인작업
...
- Caliburn.Micro
    ...
    - MVVM 특징
        ...
        - Model내의 속성 DB 테이블 컬럼 이름 일치, CRUD 쿼리문 오타 주의
        - ViewModel 부분
            - 변수, 속성으로 분리
